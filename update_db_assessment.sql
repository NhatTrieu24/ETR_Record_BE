...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260802170642_AddInstructorAccountIdToClass'
)
BEGIN
    ALTER TABLE [Classes] ADD [InstructorAccountId] int NULL;
END;
...
BEGIN
    CREATE INDEX [IX_Classes_InstructorAccountId] ON [Classes] ([InstructorAccountId]);
END;
...
BEGIN
    ALTER TABLE [Classes] ADD CONSTRAINT [FK_Classes_Accounts_InstructorAccountId] FOREIGN KEY ([InstructorAccountId]) REFERENCES [Accounts] ([AccountId]) ON DELETE NO ACTION;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260802170642_AddInstructorAccountIdToClass', N'9.0.0');
END;

IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260804171408_AddUserProfileStatusAndRemoveDashboardSnapshot'
)
BEGIN
    DROP TABLE [DashboardSnapshots];
END;
...
BEGIN
    ALTER TABLE [UserProfiles] ADD [Status] nvarchar(max) NOT NULL DEFAULT N'Active';
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260804171408_AddUserProfileStatusAndRemoveDashboardSnapshot', N'9.0.0');
END;

IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260805135129_AddAssessmentIdToSession'
)
BEGIN
    ALTER TABLE [Sessions] ADD [AssessmentId] int NULL;
END;
...
BEGIN
    CREATE INDEX [IX_Sessions_AssessmentId] ON [Sessions] ([AssessmentId]);
END;
...
BEGIN
    ALTER TABLE [Sessions] ADD CONSTRAINT [FK_Sessions_Assessments_AssessmentId] FOREIGN KEY ([AssessmentId]) REFERENCES [Assessments] ([AssessmentId]) ON DELETE NO ACTION;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260805135129_AddAssessmentIdToSession', N'9.0.0');
END;
