...
public interface IPracticalChecklistResultService
{
    ...
    Task<PracticalChecklistResultResponse> CreatePracticalChecklistResultAsync(CreatePracticalChecklistResultRequest request, int verifiedByAccountId, CancellationToken cancellationToken = default);
    ...
    Task<PracticalChecklistResultResponse> PublishPracticalChecklistResultAsync(int id, int publishedByAccountId, CancellationToken cancellationToken = default);
}
