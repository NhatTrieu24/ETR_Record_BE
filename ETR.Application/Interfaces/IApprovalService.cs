...
public interface IApprovalService
{
    ...
    Task<ApprovalRequestResponse> ProcessApprovalActionAsync(int approvalRequestId, string action, int actionByAccountId, string? actionByRoleName, string? comment, CancellationToken cancellationToken = default);
