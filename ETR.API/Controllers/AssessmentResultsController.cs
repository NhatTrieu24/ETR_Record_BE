...
public class AssessmentResultsController : ControllerBase
{
    ...
    public AssessmentResultsController(IAssessmentResultService assessmentResultService, ICurrentUserService currentUserService)
    {
    ...
    public async Task<IActionResult> UpdateAssessmentResult(int id, [FromBody] UpdateAssessmentResultRequest request, CancellationToken cancellationToken)
    {
        ...
        var response = await _assessmentResultService.UpdateAssessmentResultAsync(id, request, accountId, cancellationToken);
        return Ok(response);
    }
    ...
    public async Task<IActionResult> DeleteAssessmentResult(int id, CancellationToken cancellationToken)
    {
        ...
        await _assessmentResultService.DeleteAssessmentResultAsync(id, accountId, cancellationToken);
        return NoContent();
    }
}
