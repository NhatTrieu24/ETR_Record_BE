...
| **Learner (Student)** | Đối tượng đào tạo | Không có account đăng nhập trực tiếp trong scope hiện tại — được quản lý qua UserProfile bởi Academic Staff/Instructor |
...
- **Role**: `RoleId, RoleName, Description` — giá trị chuẩn: `Admin, AcademicStaff, Instructor, QAStaff, TrainingManager, Auditor`
...
3. Chỉ **Admin** có quyền gán/đổi Role và Department cho Account (`PUT /accounts/{id}/role`, `PUT /accounts/{id}/department`).
