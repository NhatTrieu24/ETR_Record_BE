...
| Actor | Quyền hạn |
|---|---|
| **Academic Staff / Training Manager** | Tạo/cập nhật Course, mở Class, gán Instructor, Enroll/Withdraw Learner |
| **Instructor** | Read-only Course/Class thông tin cấu hình (không sửa "luật chơi") |
...
| **Class** | "Thực thể sống" sinh ra từ 1 Course | Có `StartDate/EndDate`, `Location`, `Capacity`, `InstructorAccountId`, `Status` |
