...
namespace ETR.Infrastructure.Migrations
{
    ...
    [Migration("20260722170654_AddAttemptNoToAssessmentResultUniqueIndex")]
    partial class AddAttemptNoToAssessmentResultUniqueIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ETR.Domain.Entities.AssessmentResult", b =>
                {
                    ...
                    b.HasIndex("AssessmentId", "AccountId", "SessionId", "AttemptNo")
                        .IsUnique()
            ...
            modelBuilder.Entity("ETR.Domain.Entities.Session", b =>
                {
                    ...
                    b.Property<bool>("IsChecklistRequired")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ETR.Domain.Entities.AssessmentResult", b =>
                {
                    ...
                    b.HasOne("ETR.Domain.Entities.Session", "Session")
                        .WithMany()
