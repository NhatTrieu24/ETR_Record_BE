...
| **Instructor** | Xem UserProfile của Learner thuộc lớp mình phụ trách (read-only, qua ClassStudent) |
...
- **UserProfile**: `AccountId (FK Account), UserCode, FullName, Email, Phone, DateOfBirth, Gender, Organization, Status`
  - `Status` giá trị chuẩn: `Active, Withdrawn, Graduated` — **cần bổ sung `Grounded`** cho đặc thù hàng không (xem Module 4 & TODO doc).
